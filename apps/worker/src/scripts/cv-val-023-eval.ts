/**
 * CV-VAL-023: plurality accuracy vs crowd size (decorrelation + constrained diversity).
 * Usage: npx tsx src/scripts/cv-val-023-eval.ts
 */
...
async function main(): Promise<void> {
  ...
  const labels = [100, 500, 2000, 5000, 10_000].map((n) => `cv_val023_${n}`);
